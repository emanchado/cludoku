...
{{
var G__8734 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8734;
continue;
}
} else
...
{var pred__8738 = cljs.core._EQ_;var expr__8739 = limit;if(cljs.core.truth_(pred__8738.call(null,1,expr__8739)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__8738.call(null,2,expr__8739)))
...
var G__8741 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8742 = (limit__$1 - 1);
var G__8743 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8741;
limit__$1 = G__8742;
parts = G__8743;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___8745 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___8745))
{var replacement_8746 = temp__4090__auto___8745;buffer.append([cljs.core.str(replacement_8746)].join(''));
} else
{buffer.append(ch);
}
{

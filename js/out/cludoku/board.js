...
cludoku.board.Board.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__4047__auto__){var self__ = this;
...
cludoku.board.Board.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__4052__auto__,k__4053__auto__){var self__ = this;
var this__4052__auto____$1 = this;return cljs.core._lookup.call(null,this__4052__auto____$1,k__4053__auto__,null);
});
cludoku.board.Board.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4054__auto__,k5733,else__4055__auto__){var self__ = this;
var this__4054__auto____$1 = this;if(cljs.core.keyword_identical_QMARK_.call(null,k5733,new cljs.core.Keyword(null,"block-width","block-width",813341688)))
{return self__.block_width;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k5733,new cljs.core.Keyword(null,"block-height","block-height",2953404889)))
{return self__.block_height;
} else
{if(cljs.core.keyword_identical_QMARK_.call(null,k5733,new cljs.core.Keyword(null,"cells","cells",1108448963)))
{return self__.cells;
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{return cljs.core.get.call(null,self__.__extmap,k5733,else__4055__auto__);
} else
{return null;
}
}
...
cludoku.board.Board.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4059__auto__,k__4060__auto__,G__5732){var self__ = this;
var this__4059__auto____$1 = this;var pred__5735 = cljs.core.keyword_identical_QMARK_;var expr__5736 = k__4060__auto__;if(cljs.core.truth_(pred__5735.call(null,new cljs.core.Keyword(null,"block-width","block-width",813341688),expr__5736)))
{return (new cludoku.board.Board(G__5732,self__.block_height,self__.cells,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__5735.call(null,new cljs.core.Keyword(null,"block-height","block-height",2953404889),expr__5736)))
{return (new cludoku.board.Board(self__.block_width,G__5732,self__.cells,self__.__meta,self__.__extmap,null));
} else
{if(cljs.core.truth_(pred__5735.call(null,new cljs.core.Keyword(null,"cells","cells",1108448963),expr__5736)))
{return (new cludoku.board.Board(self__.block_width,self__.block_height,G__5732,self__.__meta,self__.__extmap,null));
} else
{return (new cludoku.board.Board(self__.block_width,self__.block_height,self__.cells,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4060__auto__,G__5732),null));
}
}
}
});
cludoku.board.Board.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__4066__auto__,writer__4067__auto__,opts__4068__auto__){var self__ = this;
...
cludoku.board.Board.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__4064__auto__){var self__ = this;
var this__4064__auto____$1 = this;return cljs.core.seq.call(null,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"block-width","block-width",813341688),self__.block_width],null)),(new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"block-height","block-height",2953404889),self__.block_height],null)),(new cljs.core.PersistentVector(null,2,5,cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"cells","cells",1108448963),self__.cells],null))], null),self__.__extmap));
});
cludoku.board.Board.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__4056__auto__){var self__ = this;
var this__4056__auto____$1 = this;return (3 + cljs.core.count.call(null,self__.__extmap));
});
cludoku.board.Board.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__4048__auto__,other__4049__auto__){var self__ = this;
...
cludoku.board.Board.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4051__auto__,G__5732){var self__ = this;
var this__4051__auto____$1 = this;return (new cludoku.board.Board(self__.block_width,self__.block_height,self__.cells,G__5732,self__.__extmap,self__.__hash));
});
cludoku.board.Board.prototype.cljs$core$ICloneable$_clone$arity$1 = (function (this__4046__auto__){var self__ = this;
var this__4046__auto____$1 = this;return (new cludoku.board.Board(self__.block_width,self__.block_height,self__.cells,self__.__meta,self__.__extmap,self__.__hash));
});
cludoku.board.Board.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__4050__auto__){var self__ = this;
var this__4050__auto____$1 = this;return self__.__meta;
});
cludoku.board.Board.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__4061__auto__,k__4062__auto__){var self__ = this;
var this__4061__auto____$1 = this;if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"block-height","block-height",2953404889),null,new cljs.core.Keyword(null,"cells","cells",1108448963),null,new cljs.core.Keyword(null,"block-width","block-width",813341688),null], null), null),k__4062__auto__))
...
{return (new cludoku.board.Board(self__.block_width,self__.block_height,self__.cells,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4062__auto__)),null));
}
});
cludoku.board.Board.cljs$lang$type = true;
cludoku.board.Board.cljs$lang$ctorPrSeq = (function (this__4086__auto__){return cljs.core._conj.call(null,cljs.core.List.EMPTY,"cludoku.board/Board");
});
cludoku.board.Board.cljs$lang$ctorPrWriter = (function (this__4086__auto__,writer__4087__auto__){return cljs.core._write.call(null,writer__4087__auto__,"cludoku.board/Board");
});
...
cludoku.board.map__GT_Board = (function map__GT_Board(G__5734){return (new cludoku.board.Board(new cljs.core.Keyword(null,"block-width","block-width",813341688).cljs$core$IFn$_invoke$arity$1(G__5734),new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(G__5734),new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(G__5734),null,cljs.core.dissoc.call(null,G__5734,new cljs.core.Keyword(null,"block-width","block-width",813341688),new cljs.core.Keyword(null,"block-height","block-height",2953404889),new cljs.core.Keyword(null,"cells","cells",1108448963))));
});
...
cludoku.board.board_row = (function board_row(board,row_number){return cljs.core.merge.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.call(null,(function (p1__5738_SHARP_){return cljs.core._EQ_.call(null,cljs.core.ffirst.call(null,p1__5738_SHARP_),row_number);
}),new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(board)));
});
cludoku.board.board_col = (function board_col(board,col_number){return cljs.core.merge.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.call(null,(function (p1__5739_SHARP_){return cljs.core._EQ_.call(null,cljs.core.second.call(null,cljs.core.first.call(null,p1__5739_SHARP_)),col_number);
}),new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(board)));
});
cludoku.board.board_block = (function board_block(board,block_number){var first_row = (cljs.core.quot.call(null,block_number,new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(board)) * new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(board));var last_row = ((first_row + new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(board)) - 1);var first_col = cljs.core.mod.call(null,(block_number * new cljs.core.Keyword(null,"block-width","block-width",813341688).cljs$core$IFn$_invoke$arity$1(board)),cludoku.board.dim.call(null,board));var last_col = ((first_col + new cljs.core.Keyword(null,"block-width","block-width",813341688).cljs$core$IFn$_invoke$arity$1(board)) - 1);return cljs.core.merge.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.call(null,(function (p1__5740_SHARP_){return ((cljs.core.ffirst.call(null,p1__5740_SHARP_) >= first_row)) && ((cljs.core.ffirst.call(null,p1__5740_SHARP_) <= last_row)) && ((cljs.core.second.call(null,cljs.core.first.call(null,p1__5740_SHARP_)) >= first_col)) && ((cljs.core.second.call(null,cljs.core.first.call(null,p1__5740_SHARP_)) <= last_col));
}),new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(board)));
});
cludoku.board.block_for_cell = (function block_for_cell(board,p__5741){var vec__5743 = p__5741;var row_n = cljs.core.nth.call(null,vec__5743,0,null);var col_n = cljs.core.nth.call(null,vec__5743,1,null);var block_row = cljs.core.quot.call(null,row_n,new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(board));var block_col = cljs.core.quot.call(null,col_n,new cljs.core.Keyword(null,"block-width","block-width",813341688).cljs$core$IFn$_invoke$arity$1(board));var block_number = ((new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(board) * block_row) + block_col);return cludoku.board.board_block.call(null,board,block_number);
});
...
cludoku.board.well_formed_QMARK_ = (function well_formed_QMARK_(proto_board){var dimensions = (new cljs.core.Keyword(null,"block-height","block-height",2953404889).cljs$core$IFn$_invoke$arity$1(proto_board) * new cljs.core.Keyword(null,"block-width","block-width",813341688).cljs$core$IFn$_invoke$arity$1(proto_board));return (cljs.core.every_QMARK_.call(null,(function (p1__5744_SHARP_){return cljs.core._EQ_.call(null,cljs.core.count.call(null,p1__5744_SHARP_),dimensions);
}),new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(proto_board))) && (cljs.core._EQ_.call(null,cljs.core.count.call(null,new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(proto_board)),dimensions)) && (cljs.core.every_QMARK_.call(null,(function (x){return cljs.core.every_QMARK_.call(null,(function (p1__5745_SHARP_){return ((p1__5745_SHARP_ == null)) || (((p1__5745_SHARP_ >= 1)) && ((p1__5745_SHARP_ <= dimensions)));
}),x);
}),new cljs.core.Keyword(null,"cells","cells",1108448963).cljs$core$IFn$_invoke$arity$1(proto_board)));
});
cludoku.board.remove_candidate = (function remove_candidate(number,cell_set){var result = cljs.core.reduce.call(null,(function (update,p__5749){var vec__5750 = p__5749;var cell_pos = cljs.core.nth.call(null,vec__5750,0,null);var cell_cands = cljs.core.nth.call(null,vec__5750,1,null);return cljs.core.into.call(null,update,((((cljs.core.count.call(null,cell_cands) > 1)) && (cljs.core.contains_QMARK_.call(null,cell_cands,number)))?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cell_pos,cljs.core.set.call(null,cljs.core.remove.call(null,((function (vec__5750,cell_pos,cell_cands){
return (function (p1__5746_SHARP_){return cljs.core._EQ_.call(null,number,p1__5746_SHARP_);
});})(vec__5750,cell_pos,cell_cands))
,cell_cands))], null)], null):null));
}),cljs.core.PersistentArrayMap.EMPTY,cell_set);return result;
});
cludoku.board.remove_final_numbers = (function remove_final_numbers(board,new_final_numbers){var update = cljs.core.reduce.call(null,(function (acc_cells,final_number){var vec__5754 = final_number;var pos = cljs.core.nth.call(null,vec__5754,0,null);var one_element_set = cljs.core.nth.call(null,vec__5754,1,null);var number = cljs.core.first.call(null,one_element_set);var acc_board = cljs.core.update_in.call(null,board,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"cells","cells",1108448963)], null),cljs.core.merge,acc_cells);var row_wo_final = cludoku.board.remove_candidate.call(null,number,cludoku.board.board_row.call(null,acc_board,cljs.core.first.call(null,pos)));var col_wo_final = cludoku.board.remove_candidate.call(null,number,cludoku.board.board_col.call(null,acc_board,cljs.core.second.call(null,pos)));var block_wo_final = cludoku.board.remove_candidate.call(null,number,cludoku.board.block_for_cell.call(null,acc_board,pos));return cljs.core.merge.call(null,acc_cells,row_wo_final,col_wo_final,block_wo_final);
...
return (function (p__5755){var vec__5756 = p__5755;var _ = cljs.core.nth.call(null,vec__5756,0,null);var new_cand_set = cljs.core.nth.call(null,vec__5756,1,null);return cljs.core._EQ_.call(null,cljs.core.count.call(null,new_cand_set),1);
...
cludoku.board.consistent_sets_QMARK_ = (function consistent_sets_QMARK_(board,set_function){return cljs.core.every_QMARK_.call(null,(function (n){var final_numbers = cljs.core.map.call(null,cljs.core.first,cljs.core.filter.call(null,(function (p1__5761_SHARP_){return cljs.core._EQ_.call(null,cljs.core.count.call(null,p1__5761_SHARP_),1);
}),cljs.core.map.call(null,cljs.core.second,set_function.call(null,board,n))));var or__3466__auto__ = cljs.core.empty_QMARK_.call(null,final_numbers);if(or__3466__auto__)
...
cludoku.board.update_board = (function update_board(board,update){var final_numbers = cljs.core.filter.call(null,(function (p1__5762_SHARP_){return cljs.core._EQ_.call(null,cljs.core.count.call(null,cljs.core.second.call(null,p1__5762_SHARP_)),1);
